    ...
    `;getCardSize(){return this._inner?.getCardSize?.()||3}}we("sem-require",Ce,{type:"sem-require",name:"SEM Require Wrapper",description:"Renders a card only when its HACS dependency is installed; otherwise a friendly install notice",documentationURL:"https://github.com/traktore-org/sem-community/blob/develop/docs/DASHBOARD_GUIDE.md#sem-require",preview:!1});const ze=(e,t)=>"function"==typeof semLocalize?semLocalize(e,t?.language):e,Me={home:{titleKey:"home",subtitleKey:"home_sub",color:"#5BC8D8",icon:()=>G`
            ...
            <div class="hero">
                <div class="hero-main">
                    ...
                    <div class="hero-label">${ze("todays_solar_production",this._hass)}</div>
                </div>
                ${t>0?W`
                <div class="hero-now">
        ...
        `}getCardSize(){return 1}static getStubConfig(){return{tab:"home"}}},{type:"sem-tab-header",name:"SEM Tab Header",description:"Lumina-styled tab header with glow icon and live stats",documentationURL:"https://github.com/traktore-org/sem-community/blob/develop/docs/DASHBOARD_GUIDE.md#sem-tab-header"});const De={"clear-night":{icon:"🌙",key:"weather_clear"},cloudy:{icon:"☁️",key:"weather_cloudy"},fog:{icon:"🌫️",key:"weather_fog"},hail:{icon:"🧊",key:"weather_hail"},lightning:{icon:"⚡",key:"weather_thunder"},"lightning-rainy":{icon:"⛈️",key:"weather_thunderstorm"},partlycloudy:{icon:"⛅",key:"weather_partly_cloudy"},pouring:{icon:"🌧️",key:"weather_pouring"},rainy:{icon:"🌦️",key:"weather_rain"},snowy:{icon:"❄️",key:"weather_snow"},"snowy-rainy":{icon:"🌨️",key:"weather_sleet"},sunny:{icon:"☀️",key:"weather_sunny"},windy:{icon:"💨",key:"weather_windy"},"windy-variant":{icon:"💨",key:"weather_windy"},exceptional:{icon:"⚠️",key:"weather_exceptional"}};we("sem-weather-card",class extends Se{static get styles(){return[ke]}constructor(){super(),this._clockTime="--:--",this._clockDate="",this._clockInterval=null}static get watchedEntities(){return[]}setConfig(e){if(!e.entity)throw new Error("sem-weather-card requires entity");super.setConfig(e)}set hass(e){this._hass,this._hass=e;const t=e?.language,i="function"==typeof semLocalize;let s=!1;if((t!==this._lang||i&&!this._localizeReady)&&(this._lang=t,this._localizeReady=i,s=!0),this._isFrozen()&&!s)return;const r=this._config?.entity;if(!r)return;const a=e?.states[r],o=(a?.state||"")+JSON.stringify(a?.attributes?.forecast?.[0]||"")+"|"+(t||"");(o!==this._lastWeatherKey||s)&&(this._lastWeatherKey=o,this.requestUpdate())}get hass(){return this._hass}connectedCallback(){super.connectedCallback(),this._updateClock(),this._clockInterval=setInterval(()=>{this._updateClock()},3e4)}disconnectedCallback(){super.disconnectedCallback(),this._clockInterval&&(clearInterval(this._clockInterval),this._clockInterval=null)}_updateClock(){const e=new Date,t=this._hass?.language||navigator.language||"en",i=this._hass?.config?.time_zone||void 0;this._clockTime=e.toLocaleTimeString(t,{hour:"2-digit",minute:"2-digit",timeZone:i}),this._clockDate=e.toLocaleDateString(t,{weekday:"long",day:"numeric",month:"long",year:"numeric",timeZone:i}),this.requestUpdate()}_renderForecastRows(e,t){const i=this._hass?.language||navigator.language||"en",s=this._hass?.config?.time_zone||void 0;return e.slice(0,t).map(e=>{const t=new Date(e.datetime).toLocaleDateString(i,{weekday:"short",timeZone:s}),r=De[e.condition]?.icon||"❓",a=null!=e.templow?Math.round(e.templow):"—",o=null!=e.temperature?Math.round(e.temperature):"—",n="number"==typeof o&&"number"==typeof a?o-a:0,l=Math.max(n/30*100,10),c="number"==typeof o&&"number"==typeof a?(a+o)/2:15,d=Math.min(Math.max((c-0)/30,0),1),p=d>.5?`rgba(255,${Math.round(200-100*d)},0,0.6)`:`rgba(${Math.round(100+200*d)},${Math.round(180+40*d)},255,0.5)`;return W`
            ...
            `;const s=this._theme(),r=i.state,a=i.attributes,o=null!=a.temperature?Math.round(a.temperature):"—",n=a.temperature_unit||"°C",l=null!=a.humidity?Math.round(a.humidity):"—",c=null!=a.wind_speed?Math.round(a.wind_speed):"—",d=a.wind_speed_unit||"km/h",p=De[r]||{icon:"❓",key:""},h=a.forecast||[];return W`
            <style>
                :host { display: block; }
                .wrap {
                        ...
                        <div class="flows-grid">
                            ...
                            <div class="flow-row">
                                ...
                                <div class="flow-vals">
                                    ...
                                    <div class="flow-energy">${this._fmt(m,2)} kWh</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section two-col">
                        <div>
                            ...
                            <div class="metric-row">
                                ...
                                <span class="metric-val">${this._fmt(f,1)} kWh</span>
                            </div>
                            <div class="metric-row">
        ...
        `}getCardSize(){return 5}static getStubConfig(){return{entity_prefix:Ue}}},{type:"sem-solar-card",name:"SEM Solar",description:"Consolidated solar production card with flows, forecast, and performance metrics",documentationURL:"https://github.com/traktore-org/sem-community/blob/develop/docs/DASHBOARD_GUIDE.md#sem-solar-card"});const We=["sensor.sem_daily_solar_energy","sensor.sem_solar_power"];we("sem-solar-kpi-card",class extends Se{static get watchedEntities(){return We}setConfig(e){super.setConfig(e),this._prefix=e.entity_prefix||"sensor.sem_"}_val(e,t=0){const i=this._hass?.states[`${this._prefix}${e}`];if(!i||"unavailable"===i.state||"unknown"===i.state)return t;const s=parseFloat(i.state);return Number.isFinite(s)?s:t}static get styles(){return a`
                :host { display: block; }
                .kpi {
                    display: flex;
                    align-items: center;
        ...
        `}_renderModeControls(e,t){const i=this._hass?.states[e];if(!i)return q;const s=this._hass?.states[t],r=i.state,a=s&&("allow_arbitrage"===r||"force_discharge"===r),o=this._t("battery_mode_hint_"+r)||"";return W`
        ...
        `}_renderBatterySection(e,t){const i=Ze[t%Ze.length],s=this._val(`battery_${e}_power`,0),r=this._val(`battery_${e}_soc`,null),a=(this._valStr(`battery_${e}_status`)||"idle").toLowerCase(),o=this._val(`battery_${e}_capacity_kwh`,0),n=this._batteryName(e),l="selling"===a,c=!l&&("charging"===a||s>50),d=!l&&("discharging"===a||s<-50),p=c||d||l,h=l?"selling_to_grid":c?"charging":d?"discharging":"idle",_=l?"#FCD170":c?"#f06292":d?"#4db6ac":"#999",g=null!=r&&o>0?r/100*o:null,u=Ke(r,o,s);return W`
                    ...
                    <div class="battery-section-metrics">
                        ...
                        ${u?W`
                            <div class="bs-row">
                                ...
                                <span class="bs-val">${Ve(u.hours)}</span>
                            </div>
                        `:q}
                    </div>
                </div>
        ...
        `}getCardSize(){return 5}static getStubConfig(){return{entity_prefix:Je}}},{type:"sem-grid-card",name:"SEM Grid",description:"Consolidated grid card with import/export, peak management, load control, tariff, and surplus",documentationURL:"https://github.com/traktore-org/sem-community/blob/develop/docs/DASHBOARD_GUIDE.md#sem-grid-card"});const et="sensor.sem_",tt=20;function it(e){return 36+556*e}function st(e){if(!e||"string"!=typeof e)return null;const t=e.match(/^(\d{1,2}):(\d{2})$/);if(!t)return null;const i=parseInt(t[1],10),s=parseInt(t[2],10);return i>24||s>59?null:(i+s/60)/24}function rt(e){if(!Array.isArray(e))return[];const t=[];let i=-1;for(let s=0;s<24;s++)e[s]&&-1===i?i=s:e[s]||-1===i||(t.push({start:i/24,end:s/24}),i=-1);return-1!==i&&t.push({start:i/24,end:1}),t}we("sem-schedule-card",class extends Se{static get watchedEntities(){return[`${et}tariff_current_import_rate`,`${et}tariff_price_level`,`${et}night_start_time`,`${et}night_end_time`,`${et}best_surplus_window`,`${et}predicted_surplus_window`,`${et}ev_power`,`${et}charging_state`,`${et}surplus_total_w`]}setConfig(e){super.setConfig(e),this._prefix=e.entity_prefix||et}set hass(e){this._hass=e;const t=e?.language,i="function"==typeof semLocalize;let s=!1;if((t!==this._lang||i&&!this._localizeReady)&&(this._lang=t,this._localizeReady=i,s=!0),this._isFrozen()&&!s)return;const r=["tariff_current_import_rate","tariff_price_level","night_start_time","night_end_time","best_surplus_window","predicted_surplus_window","ev_power","charging_state"].map(t=>{const i=e?.states[`${this._prefix}${t}`];return(i?.state||"")+JSON.stringify(i?.attributes?.schedule_today||"")+JSON.stringify(i?.attributes?.tariff_schedule_today||"")+JSON.stringify(i?.attributes?.schedule_surplus_hours||"")+JSON.stringify(i?.attributes?.schedule_ev_hours||"")}),a=r.join("|")+"|"+t;(a!==this._lastSchedKey||s)&&(this._lastSchedKey=a,this._scheduleUpdate())}get hass(){return this._hass}_stateObj(e){return this._hass?.states[`${this._prefix}${e}`]||null}_getTariffSchedule(){const e=this._stateObj("tariff_current_import_rate")||this._stateObj("tariff_price_level"),t=e?.attributes?.schedule_today||e?.attributes?.tariff_schedule_today;if(Array.isArray(t)&&t.length>0)return t.map(e=>({start:st(e.start)??0,end:st(e.end)??1,level:e.level||("NT"===(e.tariff||e.type||"HT").toUpperCase()?"cheap":"normal"),type:(e.tariff||e.type||"HT").toUpperCase(),avgPrice:e.avg_price}));const i=this._stateObj("tariff_price_level")?.state,s=new Set(["cheap","very_cheap","normal","expensive","very_expensive"]);return i&&s.has(i)?[{start:0,end:1,level:i,type:"cheap"===i||"very_cheap"===i?"NT":"HT",isFallback:!0}]:[{start:0,end:1,level:"normal",type:"HT",isFallback:!0}]}_getNightWindow(){const e=st(this._stateObj("night_start_time")?.state),t=st(this._stateObj("night_end_time")?.state);return null==e||null==t?null:{start:e,end:t}}_getPredictedSurplusWindow(){for(const e of["predicted_surplus_window","best_surplus_window"]){const t=this._stateObj(e)?.state;if(!t||"unknown"===t||"unavailable"===t)continue;if(t.toLowerCase().startsWith("tomorrow"))continue;const i=t.split(/[-–]/);if(2!==i.length)continue;const s=st(i[0].trim()),r=st(i[1].trim());if(null!=s&&null!=r)return{start:s,end:r}}return null}_getSurplusBlocks(){const e=this._hass?.states[`${this._prefix}surplus_total_w`];return rt(e?.attributes?.schedule_surplus_hours)}_getEvBlocks(){const e=this._hass?.states[`${this._prefix}surplus_total_w`];return rt(e?.attributes?.schedule_ev_hours)}_getEvPlanWindow(){const e=this._stateObj("charging_state"),t=e?.attributes?.today_plan;if(!Array.isArray(t))return null;const i=new Date;i.setHours(0,0,0,0);const s=i.getTime()+864e5,r=e=>{const t=new Date(e).getTime();return t<i.getTime()||t>=s?null:(t-i.getTime())/864e5};let a,o,n,l;for(const e of t)"ev_charge_start"===e.kind?a=r(e.when):"ev_min_reached"===e.kind?(o=r(e.when),l=e.values?.kwh):"ev_deadline"===e.kind&&(n=r(e.when));const c=o??n;return null==a&&null==c&&null==n?null:{plan:null!=a&&null!=c&&c>a?[{start:a,end:c,kwh:l}]:[],deadlineFrac:n,minReachedFrac:o}}_getSolarIntensity(){const e=this._stateObj("forecast_peak_time_today")?.state||this._stateObj("peak_time_today")?.state,t=parseFloat(this._stateObj("forecast_today_kwh")?.state||this._stateObj("forecast_today")?.state);if(!e||isNaN(t)||t<.5)return null;const i=st(e.slice(0,5));if(null==i)return null;const s=new Array(24).fill(0);for(let e=0;e<24;e++){const t=e/24-i,r=Math.exp(-t*t/(.26*.13));s[e]=r}const r=Math.max(...s);return s.map(e=>e/r)}_isEvCharging(){const e=parseFloat(this._stateObj("ev_power")?.state);if(!isNaN(e)&&e>10)return!0;const t=this._stateObj("charging_state")?.state;return t&&"charging"===t.toLowerCase()}_getNowBadges(){const e=this._stateObj("tariff_price_level")?.state,t=["cheap","normal","expensive","very_cheap","very_expensive"].includes(e)?e:null,i=["active","target_reached"].includes(this._stateObj("night_charging_status")?.state),s=parseFloat(this._stateObj("solar_power")?.state),r=!isNaN(s)&&s>50?`${(s/1e3).toFixed(1)} kW`:null,a=this._isEvCharging(),o=this._getEvPlanWindow();return{tariff:t,night:i?"now":null,surplus:r,ev:a?"charging":o?.plan?.length?"planned":null}}_buildSvgContent(e){const t=pe,i=e.textSec||"#888",s=e.textTertiary||"#777",r=e.surface||"rgba(255,255,255,0.03)";let a="";for(let e=0;e<=24;e+=2){const t=it(e/24);a+=`<text x="${t}" y="12" text-anchor="middle" fill="${i}"\n                font-size="10" font-family="'Segoe UI','Roboto',sans-serif"\n                font-variant-numeric="tabular-nums">${e.toString().padStart(2,"0")}</text>`}[this._t("tariff"),this._t("night"),this._t("surplus"),this._t("ev")].forEach((e,t)=>{a+=`<text x="32" y="${tt+22*t+9+3.5}" text-anchor="end" fill="${s}"\n                font-size="10" font-family="'Segoe UI','Roboto',sans-serif">${e}</text>`});for(let e=0;e<4;e++){a+=`<rect x="36" y="${tt+22*e}" width="556" height="18" rx="3" fill="${r}"/>`}const o={cheap:{fill:"#66bb6a",opacity:.62},normal:{fill:t.solar,opacity:.55},expensive:{fill:"#e91e63",opacity:.9}},n={cheap:"cheap",normal:"normal",expensive:"expensive"};for(const e of this._getTariffSchedule()){const t=it(e.start),i=it(e.end)-t,s=o[e.level]||o.normal,r=!0===e.isFallback,l=r?.35*s.opacity:s.opacity,c=r?` stroke="${s.fill}" stroke-width="1" stroke-opacity="0.6" stroke-dasharray="3,2"`:"",d=r?`${e.level} (no per-hour data — showing current level)`:null!=e.avgPrice?`${e.level} · avg ${e.avgPrice.toFixed(2)}`:e.level;if(a+=`<rect x="${t}" y="20" width="${i}" height="18"\n                rx="3" fill="${s.fill}" opacity="${l}"${c}>\n                <title>${d}</title></rect>`,i>30){const s=e.level&&n[e.level]?n[e.level]:e.type.toLowerCase();a+=`<text x="${t+i/2}" y="32.5" text-anchor="middle"\n                    fill="rgba(255,255,255,0.92)" font-size="9" font-weight="600"\n                    font-family="'Segoe UI','Roboto',sans-serif">${this._t(s)}</text>`}}const l=this._getNightWindow();if(l){const e=e=>{const t=Math.round(24*e*60);return`${String(Math.floor(t/60)).padStart(2,"0")}:${String(t%60).padStart(2,"0")}`},t=`${this._t("night")} ${e(l.start)}–${e(l.end)}`;if(l.start>l.end){const e=it(l.start);a+=`<rect x="${e}" y="42" width="${it(1)-e}"\n                    height="18" rx="3" fill="#42a5f5" opacity="0.55"><title>${t}</title></rect>`,a+=`<rect x="${it(0)}" y="42"\n                    width="${it(l.end)-it(0)}" height="18"\n                    rx="3" fill="#42a5f5" opacity="0.55"><title>${t}</title></rect>`}else{const e=it(l.start),i=it(l.end)-e;a+=`<rect x="${e}" y="42" width="${i}" height="18"\n                    rx="3" fill="#42a5f5" opacity="0.55"><title>${t}</title></rect>`}}const c=this._getSolarIntensity(),d=parseFloat(this._stateObj("forecast_today_kwh")?.state||NaN);if(c){const e=isNaN(d)?this._t("surplus"):`${this._t("surplus")} · forecast ${d.toFixed(1)} kWh`;for(let t=0;t<24;t++){const i=c[t];if(i<.08)continue;const s=it(t/24),r=it(1/24);a+=`<rect x="${s}" y="64" width="${r}" height="18"\n                    fill="#fdd835" opacity="${(.55*i).toFixed(2)}"><title>${e}</title></rect>`}}const p=this._getPredictedSurplusWindow();if(p){const e=it(p.start),t=Math.max(0,it(p.end)-e);a+=`<rect x="${e}" y="64" width="${t}" height="18"\n                rx="3" fill="none" stroke="#fdd835" stroke-width="1"\n                stroke-opacity="0.5" stroke-dasharray="2,2"/>`}for(const e of this._getSurplusBlocks()){const t=it(e.start),i=Math.max(0,it(e.end)-t);a+=`<rect x="${t}" y="64" width="${i}" height="18"\n                rx="3" fill="#fdd835" opacity="0.62"/>`}const h=this._getEvPlanWindow();if(h?.plan?.length)for(const e of h.plan){const i=it(e.start),s=Math.max(0,it(e.end)-i),r=e.kwh?`${this._t("plan_ev_charge_start")} → ${this._t("plan_ev_min_reached").replace("{kwh}",e.kwh)}`:this._t("plan_ev_charge_start");a+=`<rect x="${i}" y="86" width="${s}" height="18"\n                    rx="3" fill="${t.ev}" opacity="0.30"\n                    stroke="${t.ev}" stroke-width="0.6" stroke-opacity="0.6"\n                    stroke-dasharray="3,2"><title>${r}</title></rect>`}for(const e of this._getEvBlocks()){const i=it(e.start),s=Math.max(0,it(e.end)-i);a+=`<rect x="${i}" y="86" width="${s}" height="18"\n                rx="3" fill="${t.ev}" opacity="0.55"/>`}if(null!=h?.deadlineFrac){const e=it(h.deadlineFrac);a+=`<line x1="${e}" y1="84" x2="${e}" y2="106"\n                stroke="#f06292" stroke-width="1.2" stroke-dasharray="2,1" opacity="0.85">\n                <title>${this._t("plan_ev_deadline")}</title></line>`}if(this._isEvCharging()){const e=new Date,i=(e.getHours()+e.getMinutes()/60)/24,s=.5/24,r=Math.max(0,i-s),o=Math.min(1,i+s),n=it(r),l=it(o)-n;a+=`<rect x="${n}" y="86" width="${l}" height="18"\n                rx="3" fill="${t.ev}" opacity="0.95"/>`}const _=new Date,g=it((_.getHours()+_.getMinutes()/60)/24);return a+=`<line x1="${g}" y1="18" x2="${g}" y2="104"\n            stroke="#ef5350" stroke-width="1.5" stroke-linecap="round" opacity="0.9"/>`,a+=`<polygon points="${g-3},18 ${g+3},18 ${g},22"\n            fill="#ef5350" opacity="0.9"/>`,a}render(){if(!this._hass||!this._config)return q;const e=this._theme(),t=e.dotColor||"rgba(128,128,128,0.04)",i=this._buildSvgContent(e),s=this._getNowBadges(),r={cheap:"#66bb6a",very_cheap:"#66bb6a",normal:"#ff9800",expensive:"#e91e63",very_expensive:"#e91e63",now:"#42a5f5",charging:"#8DC892",planned:"#8DC892"},a=(e,t)=>{if(!t)return q;const i=r[t]||"#888",s=/\d/.test(t)?t:this._t(t);return W`<span class="now-badge"
        ...
        `}getCardSize(){return 2}static getStubConfig(){return{}}},{type:"sem-schedule-card",name:"SEM Schedule",description:"24-hour timeline showing tariff, night window, surplus window, and EV charging periods",documentationURL:"https://github.com/traktore-org/sem-community/blob/develop/docs/DASHBOARD_GUIDE.md#sem-schedule-card"});const at=[{id:"autostart",entity:"number.sem_battery_auto_start_soc",icon:"mdi:play-circle",labelKey:"auto_start_soc",helpKey:"zone_help_autostart",color:"#4db6ac"},{id:"buffer",entity:"number.sem_battery_buffer_soc",icon:"mdi:shield-half-full",labelKey:"buffer_soc",helpKey:"zone_help_buffer",color:"#ff9800"},{id:"priority",entity:"number.sem_battery_priority_soc",icon:"mdi:shield-alert",labelKey:"priority_soc",helpKey:"zone_help_priority",color:"#f44336"}];we("sem-battery-zones-card",class extends Se{static get watchedEntities(){return at.map(e=>e.entity)}static get properties(){return{...super.properties,_showHelp:{state:!0}}}constructor(){super(),this._showHelp=!1}_toggleHelp(){this._showHelp=!this._showHelp}setConfig(e){super.setConfig(e)}_getDecimalsForZone(e){const t=this._hass?.states[e];return(t&&parseFloat(t.attributes.step)||1)<1?1:0}_renderZoneMarkers(e){return at.map(t=>{const i=this._state(t.entity),s=Math.max(0,Math.min(100,i));return W`
        ...
        `}render(){if(!this._config)return q;const e=this._theme(),t=this._state(at[0].entity),i=this._state(at[1].entity),s=this._state(at[2].entity),r=`${this._t("auto_start_soc")} ${t.toFixed(0)}% · Buffer ${i.toFixed(0)}% · ${this._t("priority_soc")} ${s.toFixed(0)}%`;return W`
            <style>
                :host { display: block; contain: layout style paint; }
                .wrap {
                    padding: 16px;
        ...
        `}_renderSectionBody(e,t){if("ev_econ"===e){const e=this._val("lifetime_ev_energy");if(!(e>0))return W`<div class="info-empty">${this._t("no_ev_data")}</div>`;const i=this._val("lifetime_ev_cost"),s=this._val("lifetime_ev_solar_share"),r=this._val("lifetime_ev_battery_share"),a=this._val("lifetime_ev_grid_share"),o=i/e;return W`
                <div class="info-tiles">
                    ${this._renderInfoTile("mdi:currency-usd","#8DC892","cost_per_kwh",o.toFixed(4)+" "+t+"/kWh")}
                    ${this._renderInfoTile("mdi:solar-power","#ff9800","solar_share",s.toFixed(1)+"%")}
                    ${this._renderInfoTile("mdi:battery-arrow-down","#4db6ac","battery_share",r.toFixed(1)+"%")}
                    ${this._renderInfoTile("mdi:transmission-tower","#488fc2","grid_share",a.toFixed(1)+"%")}
                </div>
        ...
        `}render(){if(!this._config||!this._hass)return q;const e=fe(this._hass);return W`
            <div class="wrap">
                ${ct.map(t=>this._renderSection(t,e))}
            </div>
        `}static get styles(){return a`
            :host { display: block; }
            .wrap {
        ...
        `}getCardSize(){return 8}static getStubConfig(){return{entity_prefix:"sensor.sem_"}}},{type:"sem-costs-detail-card",name:"SEM Costs Detail Card",description:"Financial details — EV economics, investment, demand charge, and tariff rates",documentationURL:"https://github.com/traktore-org/sem-community/blob/develop/docs/DASHBOARD_GUIDE.md#sem-costs-detail-card",preview:!1});const dt="sensor.sem_";we("sem-charger-status-card",class extends Se{constructor(){super(),this._chargers=[],this._lastStateCount=0}set hass(e){this._hass,this._hass=e;const t=e?.language,i="function"==typeof semLocalize;let s=!1;if((t!==this._lang||i&&!this._localizeReady)&&(this._lang=t,this._localizeReady=i,s=!0),this._isFrozen()&&!s)return;if(this._chargers?.length>0&&!s){const t=this._config?.entity_prefix||dt,i=e.states[`${t}charger_${this._chargers[0]}_power`]?.state;if("unavailable"===i||"unknown"===i)return}const r=Object.keys(e.states).length;if(r!==this._lastStateCount){this._lastStateCount=r;const t=[];for(const i of Object.keys(e.states)){if(i.includes("_flow_"))continue;const e=i.match(/^sensor\.sem_charger_(.+)_power$/);e&&t.push(e[1])}this._chargers=t}const a=this._config?.entity_prefix||dt,o=this._chargers.map(t=>[`charger_${t}_power`,`charger_${t}_session_energy`,`charger_${t}_session_solar_share`,`charger_${t}_taper_trend`].map(t=>e.states[`${a}${t}`]?.state||"").join(":")).join("|");(o!==this._lastKey||s)&&(this._lastKey=o,this._scheduleUpdate())}get hass(){return this._hass}setConfig(e){super.setConfig(e),this._prefix=e.entity_prefix||dt}_val(e,t=0){const i=this._hass?.states[`${this._prefix}${e}`];return i&&"unavailable"!==i.state&&"unknown"!==i.state?parseFloat(i.state)??t:t}_valStr(e){const t=this._hass?.states[`${this._prefix}${e}`];return t&&"unavailable"!==t.state&&"unknown"!==t.state?t.state:""}_chargerName(e){const t=this._hass?.states[`${this._prefix}charger_${e}_power`];let i=e.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase());return t?.attributes?.friendly_name&&(i=t.attributes.friendly_name.replace(/^SEM\s+/i,"").replace(/\s+Power$/i,"")),i}_renderChargerTile(e){const t=this._val(`charger_${e}_power`),i=this._val(`charger_${e}_session_energy`),s=this._val(`charger_${e}_session_solar_share`),r=this._valStr(`charger_${e}_taper_trend`)||"stable",a=this._t(r),o=this._chargerName(e),n=t>50,l=n?"#8DC892":"#888",c=n?this._t("charging"):this._t("idle");return W`
        ...
        `}_renderRangeSlider(e,t,i){const s=this._hass?.states[e],r=this._hass?.states[t],a=i?"%":" kWh",o=e=>i?String(Math.round(e)):this._fmt(e,e%1==0?0:1);if(!s||!r){const t=this._entityVal(e,i?80:10);return W`<div class="ct-row">
                ...
                >${o(t)}${a}</span></span></div>`}const n=Math.min(parseFloat(s.attributes.min??0),parseFloat(r.attributes.min??0)),l=Math.max(parseFloat(s.attributes.max??100),parseFloat(r.attributes.max??100)),c=l-n||1;let d=this._entityVal(e,i?80:10),p=this._entityVal(t,100);p<d&&(p=d);const h=(d-n)/c*100,_=(p-n)/c*100,g=p>=l-1e-6,u=parseFloat(this._hass?.states[e]?.attributes?.step)||(l>50?1:5),m=Math.max(u,.02*(l-n)),f=p-d<m-1e-6;return W`
            ...
            <div class="charger-section">
                ...
                <div class="charger-body">
                    <div class="charger-soc" title="${d?this._t("soc_estimated_hint"):""}">
                        ${this._renderSocGauge(c,d)}
                        <span class="soc-label">${d?this._t("soc_estimated_label"):"SOC"}</span>
                    </div>

                    <div class="charger-metrics">
                        <div class="cm-row">
                            <span class="cm-label">${this._t("power")}</span>
                            <span class="cm-value" style="color:${w?i:""}">${ge(s)}</span>
                        </div>
                        <div class="cm-row">
        ...
        `}getCardSize(){return 5}static getStubConfig(){return{entity_prefix:"sensor.sem_"}}},{type:"sem-home-status-card",name:"SEM Home Status Card",description:"Consolidated status panel for the SEM Home tab",documentationURL:"https://github.com/traktore-org/sem-community/blob/develop/docs/DASHBOARD_GUIDE.md#sem-home-status-card",preview:!1});const gt="sensor.sem_tariff_current_import_rate",ut={negative:{color:"#4db6ac",key:"price_negative"},very_cheap:{color:"#8DC892",key:"very_cheap"},cheap:{color:"#8DC892",key:"cheap"},normal:{color:"#ff9800",key:"normal"},expensive:{color:"#f06292",key:"expensive"},very_expensive:{color:"#e53935",key:"very_expensive"}};we("sem-price-card",class extends Se{constructor(){super(),this._boundVisibility=()=>{document.hidden||this.requestUpdate()}}connectedCallback(){super.connectedCallback(),document.addEventListener("visibilitychange",this._boundVisibility)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("visibilitychange",this._boundVisibility)}setConfig(e){super.setConfig(e),this._entity=e.entity||gt,this._compact=!!e.compact}set hass(e){this._hass=e;const t=e?.states[this._entity],i=t?.attributes||{},s=[t?.state,i.price_level,i.next_cheap_start,(i.upcoming||[]).length,this._lang].join("|"),r="function"==typeof semLocalize;(s!==this._lastKey||r&&!this._localizeReady)&&(this._lastKey=s,this._lang=e?.language,this._localizeReady=r,this.requestUpdate())}get hass(){return this._hass}_hm(e){if(!e)return null;const t=this._hass?.config?.time_zone||void 0;try{return new Date(e).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",timeZone:t})}catch(e){return null}}_levelInfo(e){return ut[e]||{color:"#9e9e9e",key:"normal"}}render(){if(!this._hass||!this._config)return q;const e=this._hass.states[this._entity];if(!e||"unavailable"===e.state||"unknown"===e.state)return W`<ha-card><div class="wrap empty">${this._t("current_electricity_price")}: —</div></ha-card>`;const t=e.attributes||{};if(!1===t.is_dynamic)return this.style.display="none",q;this.style.display="";const i=parseFloat(e.state),s=t.currency||"",r=this._levelInfo(t.price_level),a=e=>null==e||isNaN(e)?"—":Number(e).toFixed(2),o=Array.isArray(t.upcoming)?t.upcoming:[],n=this._hm(t.next_cheap_start),l=this._hm(t.next_cheap_end);return this._compact?W`
                <ha-card>
                    <div class="chip-row">
        ...
        `}getCardSize(){return 2}static getStubConfig(){return{entity:gt}}static get styles(){return a`
        ...
        `}_renderHealthSection(e){return W`
            <div class="health-chips">
                ${ft.map(e=>{const t=`${this._prefix}${e.key}`,i=this._available(t),s=this._hass?.states[t],r=s?s.state:"—";let a=e.suffix;if("tariff_current_import_rate"===e.key){const e=s?.attributes?.currency;a=e?` ${e}/kWh`:""}return W`
        ...
        `}render(){if(!this._config)return q;const e=this._theme(),t=!1!==e.isDark,i=e.accent||"#42a5f5",s={info:e=>this._renderInfoSection(e),health:e=>this._renderHealthSection(e),diag:e=>this._renderDiagSection(e)};return W`
            ...
            <div class="wrap">
                ${mt.map(t=>this._renderSection(t,s[t.id],e))}
                <div class="copy-row">
        ...
        `}getCardSize(){return 8}static getStubConfig(){return{entity_prefix:"sensor.sem_"}}},{type:"sem-system-card",name:"SEM System Card",description:"Integration health — version, detected hardware, grid mode, sensor availability",documentationURL:"https://github.com/traktore-org/sem-community/blob/develop/docs/DASHBOARD_GUIDE.md#sem-system-card",preview:!1});const vt={now:{icon:"mdi:clock-outline",color:"#5BC8D8"},solar_peak:{icon:"mdi:weather-sunny",color:"#ff9800"},solar_end:{icon:"mdi:weather-sunset",color:"#ff9800"},cheap_start:{icon:"mdi:arrow-down-bold",color:"#8DC892"},cheap_end:{icon:"mdi:arrow-up-bold",color:"#ff9800"},expensive_start:{icon:"mdi:flash-alert",color:"#f06292"},expensive_end:{icon:"mdi:flash-off",color:"#8DC892"},night_open:{icon:"mdi:weather-night",color:"#8353d1"},night_end:{icon:"mdi:weather-sunset-up",color:"#ff9800"},ev_charge_start:{icon:"mdi:ev-station",color:"#8DC892"},ev_min_reached:{icon:"mdi:battery-charging-80",color:"#4db6ac"},ev_target_reached:{icon:"mdi:car-electric",color:"#8DC892"},ev_deadline:{icon:"mdi:clock-end",color:"#f06292"},ev_wait:{icon:"mdi:pause-circle",color:"#8353d1"},battery_full:{icon:"mdi:battery-charging-100",color:"#f06292"},battery_empty:{icon:"mdi:battery-low",color:"#4db6ac"},device_run:{icon:"mdi:power-plug",color:"#5BC8D8"},device_done:{icon:"mdi:check-circle",color:"#8DC892"}};we("sem-today-plan-card",class extends Se{setConfig(e){super.setConfig(e),this._entity=e.entity||"sensor.sem_charging_state"}set hass(e){this._hass=e;const t=(e?.states[this._entity]?.attributes||{}).today_plan||[],i=[t.length,t[0]?.when,t.at(-1)?.when,this._lang].join("|"),s="function"==typeof semLocalize;(i!==this._lastKey||s&&!this._localizeReady)&&(this._lastKey=i,this._lang=e?.language,this._localizeReady=s,this.requestUpdate())}get hass(){return this._hass}_hm(e){if(!e)return"—";try{const t=new Date(e),i=this._hass?.config?.time_zone||void 0,s=ue(e,i),r=e=>e.toLocaleDateString("en-CA",{timeZone:i}),a=r(t),o=new Date;if(a===r(o))return s;if(a===r(new Date(o.getTime()+864e5))){return`${this._t("tomorrow")||"Tomorrow"} ${s}`}return`${t.toLocaleDateString([],{weekday:"short",timeZone:i})} ${s}`}catch(e){return"—"}}_format(e,t){let i=this._t(e);if(!i||i===e)return null;for(const[e,s]of Object.entries(t||{}))i=i.replace(new RegExp(`\\{${e}\\}`,"g"),s);return i}render(){if(!this._hass||!this._config)return q;const e=this._hass.states[this._entity],t=e?.attributes?.today_plan||[];return!Array.isArray(t)||t.length<=1?(this.style.display="none",q):(this.style.display="",W`
            <ha-card>
                <div class="wrap">
                    ...
                    <ul class="rows">
                        ${t.map(e=>{const t=vt[e.kind]||vt.now,i=this._format(e.label,e.values)||e.label,s=e.detail?this._format(e.detail,e.values):null;return W`
        ...
        `}},{type:"sem-today-plan-card",name:"SEM Today's Plan",description:"Forward-looking schedule combining tariff, solar, and EV",documentationURL:"https://github.com/traktore-org/sem-community/blob/develop/docs/DASHBOARD_GUIDE.md#sem-today-plan-card"});const bt={ev:{icon:"mdi:ev-station",color:"#8DC892",label:"energy_plan_kind_ev"},load:{icon:"mdi:power-plug",color:"#5BC8D8",label:"energy_plan_kind_load"},battery:{icon:"mdi:home-battery",color:"#f06292",label:"energy_plan_kind_battery"},comfort:{icon:"mdi:thermometer",color:"#4db6ac",label:"energy_plan_kind_comfort"}},xt={actuation:{docs:"https://github.com/traktore-org/sem-community/blob/develop/docs/ENERGY_PLANNER.md#actuation-g4"},arbitrage:{docs:"https://github.com/traktore-org/sem-community/blob/develop/docs/ENERGY_PLANNER.md#the-arbitrage-advisor"}},$t={fits:{icon:"mdi:check-circle",color:"#8DC892"},partial:{icon:"mdi:circle-slice-4",color:"#ff9800"},yields:{icon:"mdi:alert-circle-outline",color:"#f06292"}};class wt extends Se{setConfig(e){super.setConfig(e),this._entity=e.entity||"sensor.sem_energy_plan"}set hass(e){this._hass=e;const t=e?.states[this._entity],i=t?.attributes||{},s=!0===i.actuation&&Array.isArray(i.demands)?i.demands.map(e=>this._liveState(e,i.blocks)).join(","):"",r=i.tomorrow||{},a=i.coverage?Object.entries(i.coverage).map(([e,t])=>e+"="+t).join(","):"",o=[t?.state,i.computed_at,i.actuation,s,a,this._view||"today",r.prices,r.forecast_kwh,r.stamps_at,e?.states["switch.sem_energy_plan_actuation"]?.state,e?.states["sensor.sem_night_start_time"]?.state,e?.language].join("|"),n="function"==typeof semLocalize;(o!==this._lastKey||n&&!this._localizeReady)&&(this._lastKey=o,this._lang=e?.language,this._localizeReady=n,this.requestUpdate())}get hass(){return this._hass}_liveState(e,t){if(!e||"battery"===e.kind)return null;if("fits"!==e.status)return"reactive";const i=Date.now();let s=null,r=!1;for(const a of Array.isArray(t)?t:[]){if(a.id!==e.id)continue;const t=Date.parse(a.start),o=Date.parse(a.end);if(Number.isFinite(t)&&Number.isFinite(o)){if(r=!0,t<=i&&i<o)return"now";t>i&&(null===s||t<s)&&(s=t)}}return null!==s?"wait:"+s:r?"done":null}_covKey(e){if(!e||"covered"===e)return null;if(e.startsWith("verdict"))return"energy_plan_cov_yields";return{"no plan":"energy_plan_cov_no_plan","stale stamp":"energy_plan_cov_stale","outside span":"energy_plan_cov_outside","not in plan":"energy_plan_cov_not_in_plan","actuation off":"energy_plan_cov_actuation_off","nothing planned":"energy_plan_cov_nothing_planned"}[e]||"energy_plan_cov_unreadable"}_covChip(e){const t=this._covKey(e);return t?W`<span class="chip chip-reactive"
            ...
            title="${this._t(e?"energy_plan_active_note":"energy_plan_shadow_note")}">${this._t(e?"energy_plan_active":"energy_plan_shadow")}</span>`}_docsLink(e="actuation"){return W`<a class="docs-link" href="${xt[e].docs}" target="_blank"
                ...
                <div class="wrap">
                    <div class="head">
                        ...
                        <span class="chip ${g?"":"chip-active"}"
                              title="${this._t(g?"energy_plan_prices_preliminary_tip":"energy_plan_prices_final_tip")}">
                            ${this._t(g?"energy_plan_prices_preliminary":"energy_plan_prices_final")}</span>
                        ${this._docsLink()}
                    </div>
                    <div class="strip ${a?"":"nostrip"}">
                        ...
                        `:q}
                        ${_.map((e,i)=>{const s=bt[e.kind]||bt.load,r=((e,i)=>t&&Array.isArray(t.blocks)?t.blocks.filter(t=>t.id===`${e}:${i}`):[])(e.kind,i),o=[e.label,r.map(e=>`${this._hm(e.start)}–${this._hm(e.end)}`).join("\n")||null,this._t("energy_plan_provisional_tip")].filter(Boolean).join("\n");return W`
                    ...
                    <div class="idle">
                        ...
                        ${this._format("energy_plan_stamps_at",{time:this._hm(e.stamps_at)})}
                    </div>
                </div>
            </ha-card>
        `}_renderReview(){const e=this._hass?.states?.[this._entity]?.attributes?.review;if(!e)return q;const t=[];for(const i of e.demands||[]){const e=this._format("energy_plan_review_"+i.code,{nights:i.nights,asked:(i.asked_kwh||0).toFixed(1),suggested:null==i.suggested_kwh?"":Number(i.suggested_kwh).toFixed(1),actual:(i.last_kwh||0).toFixed(1)});e&&t.push({d:i,text:e,k:bt[i.kind]||bt.load})}const i=e.battery,s=i?this._format("energy_plan_review_"+i.code,{drained:(i.drained||0).toFixed(1),clipped:(i.clipped_h||0).toFixed(1),full_at:i.full_at_ts?new Date(1e3*i.full_at_ts).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):""}):null,r=e.self_consumption,a=r?this._format("energy_plan_review_"+r.code,{actual:Math.round(100*(r.actual_share||0)),predicted:Math.round(100*(r.predicted_share||0))}):null;return t.length||a||s?W`
            <div class="review">
                <div class="rev-h">${this._t("energy_plan_review_title")}</div>
                ${t.map(e=>W`
                    <div class="rev-row">
                        <ha-icon icon="${e.k.icon}"
                                 style="--mdc-icon-size:12px;color:${e.k.color}"></ha-icon>
                        <span class="rev-name">${(e.d.demand_id||"").split(":").pop()}</span>
                        <span class="rev-txt">${e.text}</span>
                    </div>
                `)}
                ${s?W`
                    <div class="rev-row">
        ...
        `;let f=a.filter(e=>0===new Date(e.start).getMinutes());f.length||(f=a);const y=Math.max(1,Math.ceil(f.length/8)),v=f.filter((e,t)=>t%y===0).map(e=>({left:(Date.parse(e.start)-n)/c*100,text:this._hm(e.start)})).filter(e=>e.left<=94),b=this._runs(a,n,c,e=>(e.home_grid_w||0)<=1),x=i.takeover?this._format("energy_plan_takeover",{time:this._hm(i.takeover)}):this._t("energy_plan_all_night"),$=i.takeover?W`
                <ha-icon icon="mdi:transmission-tower"
                         style="--mdc-icon-size:12px;color:#488fc2"></ha-icon>
                <span>${this._hm(i.takeover)}</span>
              `:W`
                <ha-icon icon="mdi:home-battery-outline"
                         style="--mdc-icon-size:12px;color:#4db6ac"></ha-icon>
                <span>${this._t("energy_plan_all_night_short")}</span>
              `,w=fe(this._hass),k=Number(i.total_cost),S=Number.isFinite(k)?`${this._t("energy_plan_est")} ${k.toFixed(2)} ${w}`:null,C=!1!==i.fits,z={};for(const e of o)(z[e.id]=z[e.id]||[]).push(e);return W`
            <ha-card>
                <div class="wrap">
                    <div class="head">
                        <ha-icon icon="mdi:weather-night" style="--mdc-icon-size:16px;color:#8353d1"></ha-icon>
                        <span class="title">${this._t("energy_plan_title")}</span>
                        ${this._viewToggle(!!i.tomorrow)}
                        ${this._modeChip(s)}
                        ${this._docsLink()}
                        <span class="stamp">${this._hm(i.computed_at)}</span>
                    </div>
                    ...
                    <div class="foot">${this._t(s?"energy_plan_active_note":"energy_plan_shadow_note")}</div>
                </div>
            </ha-card>
        `}static get styles(){return a`
            :host { display: block; }
        ...
        `}render(){if(!this._config)return q;const e=this._getLayout(),t=e.solar,i=e.inverter,s=e.battery,r=e.grid,a=e.home,o=e.ev,n=(2*Math.PI*e.socR).toFixed(1),l=(2*Math.PI*e.autarkyR).toFixed(1),c=e.font.label,d=e.font.value,p=e.font.sub,h=e.font.homeVal,_="'Segoe UI','Roboto',sans-serif",g=this._getNodeColor("grid_import"),u=this._getNodeColor("grid_export"),m=this._getNodeColor("solar"),f=this._getNodeColor("battery"),y=this._getNodeColor("home"),v=this._getNodeColor("ev"),b=Et.inverter.color,x=this._hasNode("solar"),$=this._hasNode("battery"),w=this._hasNode("grid"),k=this._hasNode("ev"),S=this._showInverter&&this._hasNode("inverter"),C=xe(this._hass,this._prefix);return W`
            <ha-card>
                <style>${$e}</style>
                ${C.length>=2?W`
                    <div class="pv-strings-row">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="${e.vb}" style="background:transparent">
                    <defs>
                        ...
                        ${this._svgRaw(this._glowFilter("glowSolar",m,8))}
                        ${this._svgRaw(this._glowFilter("glowBattery",f,8))}
                        ...
                        ${this._svgRaw(this._glowFilter("glowInverter",b,6))}
                    </defs>

                    <rect width="100%" height="100%" fill="url(#bgGrad)"/>
                    <rect width="100%" height="90%"  fill="url(#dotGrid)"/>

                    ${this._svgRaw(x?this._track(e.paths.solar,m):"")}
                    ${this._svgRaw(x||S?this._track(e.paths.home,y):"")}
                    ${this._svgRaw($?this._track(e.paths.battery,f):"")}
                    ...
                    ${this._svgRaw(x?`<g id="flow-solar" class="flow-group" style="opacity:0" data-path-d="${e.paths.solar}" data-color="${m}" data-count="2"></g>`:"")}
                    ${this._svgRaw($?`<g id="flow-battery" class="flow-group" style="opacity:0" data-path-d="${e.paths.battery}" data-color="${f}" data-count="3"></g>`:"")}
                    ${this._svgRaw(w?`<g id="flow-grid" class="flow-group" style="opacity:0" data-path-d="${e.paths.grid}" data-color="${g}" data-count="3"></g>`:"")}
                    ${this._svgRaw(x||S?`<g id="flow-home" class="flow-group" style="opacity:0" data-path-d="${e.paths.home}" data-color="${y}" data-count="2"></g>`:"")}
                    ${this._svgRaw(k?`<g id="flow-ev" class="flow-group" style="opacity:0" data-path-d="${e.paths.ev}" data-color="${v}" data-count="3"></g>`:"")}

                    ${this._svgRaw(x?`\n                    <g id="node-solar" filter="url(#glowSolar)">\n                        ${this._glowRing(t,m)}\n                        <circle cx="${t.cx}" cy="${t.cy}" r="${t.r}" fill="${this._hexToRgba(m,.07)}" stroke="${m}" stroke-width="1.8"/>\n                        <g transform="translate(${t.cx},${t.cy-8})" stroke="${m}" fill="none" opacity="0.75">\n                            <rect x="-16" y="-12" width="32" height="24" rx="3" stroke-width="1.8"/>\n                            <line x1="-16" y1="0" x2="16" y2="0" stroke-width="1.2"/>\n                            <line x1="-5" y1="-12" x2="-5" y2="12" stroke-width="1.2"/>\n                            <line x1="5" y1="-12" x2="5" y2="12" stroke-width="1.2"/>\n                            <line x1="0" y1="12" x2="0" y2="17" stroke-width="1.5"/>\n                            <line x1="-7" y1="17" x2="7" y2="17" stroke-width="1.5"/>\n                        </g>\n                    </g>\n                    <text x="${t.cx}" y="${t.cy+t.r+18}" text-anchor="middle" font-family="${_}" font-size="${c}" font-weight="600" fill="${m}">${this._escSvg(this._getNodeName("solar"))}</text>\n                    <text id="val-solar" x="${t.cx}" y="${t.cy+t.r+18+.9*d}" text-anchor="middle" font-family="${_}" font-size="${d}" font-weight="700" fill="${m}">0 W</text>\n                    <text id="val-today-solar" x="${t.cx}" y="${t.cy+t.r+18+.9*d+p+4}" text-anchor="middle" font-family="${_}" font-size="${p}" fill="${m}" opacity="0.7"> </text>\n                    `:"")}

                    ${this._svgRaw(S?`\n                    <g id="node-inverter" filter="url(#glowInverter)">\n                        <circle cx="${i.cx}" cy="${i.cy}" r="${i.r}" fill="${this._hexToRgba(b,.07)}" stroke="${b}" stroke-width="1"/>\n                        <path d="M${i.cx-10},${i.cy} Q${i.cx-4},${i.cy-8} ${i.cx},${i.cy} Q${i.cx+4},${i.cy+8} ${i.cx+10},${i.cy}" fill="none" stroke="${b}" stroke-width="1.8" opacity="0.7"/>\n                    </g>\n                    <text id="val-inverter-status" x="${i.cx}" y="${i.cy+i.r+14}" text-anchor="middle" font-family="${_}" font-size="${this._compact?11:10}" fill="var(--secondary-text-color,#5a7a9a)" opacity="0.7"> </text>\n                    `:"")}

                    ${this._svgRaw($?`\n                    <g id="node-battery" filter="url(#glowBattery)">\n                        ${this._glowRing(s,f)}\n                        <circle cx="${s.cx}" cy="${s.cy}" r="${s.r}" fill="${this._hexToRgba(f,.07)}" stroke="${f}" stroke-width="1.8"/>\n                        <circle cx="${s.cx}" cy="${s.cy}" r="${e.socR}" fill="none" stroke="${this._hexToRgba(f,.1)}" stroke-width="5"/>\n                        <circle id="soc-arc" cx="${s.cx}" cy="${s.cy}" r="${e.socR}" fill="none" stroke="${f}" stroke-width="5"\n                                stroke-dasharray="${n}" stroke-dashoffset="${n}"\n                                transform="rotate(-90 ${s.cx} ${s.cy})" stroke-linecap="round" opacity="0.75"/>\n                        <g transform="translate(${s.cx},${s.cy}) scale(0.8)" stroke="${f}" fill="none" opacity="0.7">\n                            <rect x="-8" y="-13" width="16" height="26" rx="3" stroke-width="1.8"/>\n                            <rect x="-3" y="-16" width="6" height="4" rx="1.5" fill="${f}" opacity="0.5" stroke="none"/>\n                        </g>\n                    </g>\n                    <text x="${s.cx}" y="${s.cy+s.r+18}" text-anchor="middle" font-family="${_}" font-size="${c}" font-weight="600" fill="${f}">${this._escSvg(this._getNodeName("battery"))}</text>\n                    <text id="val-battery-soc" x="${s.cx}" y="${s.cy+s.r+18+.9*d}" text-anchor="middle" font-family="${_}" font-size="${d}" font-weight="700" fill="${f}">0%</text>\n                    <text id="val-battery-power" x="${s.cx}" y="${s.cy+s.r+18+.9*d+c}" text-anchor="middle" font-family="${_}" font-size="${c}" font-weight="500" fill="${f}" opacity="0.7">0 W</text>\n                    <text id="label-battery-state" x="${s.cx}" y="${s.cy+s.r+18+.9*d+2*c}" text-anchor="middle" font-family="${_}" font-size="${p}" fill="${f}" opacity="0.7"></text>\n                    <text id="val-today-battery" x="${s.cx}" y="${s.cy+s.r+18+.9*d+2*c+p+4}" text-anchor="middle" font-family="${_}" font-size="${p}" fill="${f}" opacity="0.65"> </text>\n                    `:"")}
        ...
        `}render(){if(!this._config)return q;const e=this._getLayout(),t=this._compact,i="'Segoe UI','Roboto',sans-serif",s=e.font.label,r=e.font.value,a=e.font.sub,o=this._flowSolar(),{gridImport:n,gridExport:l}=this._flowGridPair(),c=this._flowEv();let d,p;this._entities?.battery?.charge||this._entities?.battery?.discharge?(d=this._flowBattery(),p=!1):(({value:d,stale:p}=this._readWithHold("battery_power","this._lastBattPower",6e4)),this._entities?.battery?.reverse&&(d=-d));const{value:h,stale:_}=this._readWithHold("battery_soc","this._lastBattSoc",6e4),g=p||_,u=Math.max(0,d),m=Math.max(0,-d),f=this._flowHome(o,n,l,u,m,c),y=this._computeSunPose(),{isNight:v}=y,b=v?this._computeMoonPhase():{k:0,waxing:!0},x=v?.3:.85,$=o>50?Math.min(1,.3+o/5e3):0,w=this._hass?.states["sun.sun"]?.attributes,k=this._hass?.config?.time_zone||void 0,S=w?.next_rising?ue(w.next_rising,k):"",C=w?.next_setting?ue(w.next_setting,k):"",z=ye(this).isDark,M=z?"#FCD170":"#a06a00",D=z?.45:.8,E=z?"#ff9800":"#b35c00",F=z?.4:.8,A=z?"#96CAEE":"#3d6e94",I=z?.6:.85,B=z?.35:.8,R=e.B.r/50,N=64*R,P=N-12*R,T=e.B.cy-N/2+8*R,L=Math.max(0,Math.min(P,P*(h/100))),U=T+P-L,O=u>10?"#f06292":"url(#battFillGrad)",H=u>10,j=l>n?"#8353d1":"#488fc2",K=l>10&&l>n?this._t("exporting"):n>10?this._t("importing"):"",V=l>10&&l>n?"#8353d1":"#488fc2",Y=u>10?"#f06292":"#4db6ac",X=u>10?this._t("charging"):m>10?this._t("discharging"):"",Z=u>10?"#f06292":"#4db6ac",J="on"===this._hass?.states["binary_sensor.sem_ev_connected"]?.state;let Q="",ee="#8DC892";"on"===this._hass?.states["binary_sensor.sem_ev_charging"]?.state||c>10?(Q=this._t("charging"),ee="#8DC892"):J&&(Q=this._t("connected")||"Verbunden",ee="rgba(141,200,146,0.6)");const te=this._t("today"),ie=`${te} ${this._valStr("daily_solar_energy")} kWh`,se=this._val("forecast_today_kwh"),re=se>0?`☀ ${se.toFixed(1)} kWh ${this._t("forecast")||"Forecast"}`:"",ae=`${te} ${this._valStr("daily_ev_energy")} kWh`,oe=`${te} ${this._val("daily_home_energy").toFixed(1)} kWh`,ne=`+${this._val("daily_battery_charge_energy").toFixed(1)} / -${this._val("daily_battery_discharge_energy").toFixed(1)} kWh`,le=Ke(h,this._val("diag_battery_capacity"),d),ce=le?`${this._t(le.key)} · ${Ve(le.hours)}`:"",de=`↓${this._val("daily_grid_import_energy").toFixed(1)} / ↑${this._val("daily_grid_export_energy").toFixed(1)} kWh`,pe=function(e,t,i={}){const{decimals:s=0,space:r=!1}=i;if(null==e||""===e||isNaN(parseFloat(e)))return"";const a=t||"°C";return`${parseFloat(e).toFixed(s)}${r?" ":""}${a}`}(this._valStr("inverter_temperature"),this._unitStr("inverter_temperature")),he=this._valStr("charging_state"),_e=t?22:30,fe=he.length>_e?he.substring(0,_e-1)+"…":he,ve=[],be=["solar_power","grid_import_power","grid_export_power"];this._showBattery&&be.push("battery_power","battery_soc"),this._showEv&&be.push("ev_power");for(const e of be){const t=this._eid(e);if(!t){"prefix"===this._mode&&ve.push(e);continue}const i=this._hass?.states[t];i&&"unavailable"!==i.state&&"unknown"!==i.state||ve.push(e)}const we=ge(this._solarDisp??0),ke=(u>10?"↑ ":m>10?"↓ ":"")+ge(this._battDisp??0),Se=ge(this._homeDisp??0),Ce=ge(this._evDisp??0),ze=this._gridDispMode?`${this._gridDispMode} ${ge(this._gridDisp??0)}`:ge(0),Me="↑"===this._gridDispMode?"#8353d1":"#488fc2",De=xe(this._hass,this._prefix),Ee=o>10,Fe=Math.abs(d)>10,Ae=d<0,Ie=u>10?"#f06292":"#4db6ac",Be=n>10||l>10,Re=n>l,Ne=l>n?"#8353d1":"#488fc2",Pe=f>10,Te=c>10;return W`
            <ha-card>
                <style>${$e}</style>
                ${De.length>=2?W`
                    <div class="pv-strings-row">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="${e.vb}"
                    ...
                    <g class="flow-group" style="opacity:${Ee?1:0}">
                        ${this._renderFlow(!1,"#ff9800",me(o),e.paths.solar,2)}
                    </g>
                    ${this._showBattery?G`<g class="flow-group" style="opacity:${Fe?1:0}">
                        ${this._renderFlow(Ae,Ie,me(d),e.paths.battery,3)}
                    </g>`:q}
                    <g class="flow-group" style="opacity:${Be?1:0}">
                        ${this._renderFlow(Re,Ne,me(n||l),e.paths.grid,3)}
                    </g>
                    <g class="flow-group" style="opacity:${Pe?1:0}">
                        ${this._renderFlow(!1,"#5BC8D8",me(f),e.paths.home,2)}
                    </g>
                    ${this._showEv?G`<g class="flow-group" style="opacity:${Te?1:0}">
                    ...
                    <text x="${e.S.cx}" y="${e.S.labelY+1.1*r}" class="clickable"
                          ...
                          font-weight="800" fill="#ff9800">${we}</text>
                    ...
                    <text x="${e.I.cx}" y="${e.I.cy+e.I.r+14}"
                          text-anchor="middle" font-family="${i}" font-size="${a}"
                          fill="${A}" opacity="${I}" font-weight="600">${pe}</text>
                    <text x="${e.I.cx}" y="${e.I.cy+e.I.r+14+a+2}"
                          text-anchor="middle" font-family="${i}" font-size="${a-1}"
                          fill="${A}" opacity="${B}">${fe}</text>
                    ...
                    <text x="${e.B.cx}" y="${e.B.labelY+1*r+s+a+2}" class="clickable"
                          ...
                          text-anchor="middle" font-family="${i}" font-size="${a+1}"
                          fill="#4db6ac" opacity="0.6" font-weight="600">${ne}</text>
                    ${ce?G`<text x="${e.B.cx}" y="${e.B.labelY+1*r+s+2*(a+2)}"
                          text-anchor="middle" font-family="${i}" font-size="${a}"
                          fill="${Z}" opacity="0.75" font-weight="600">${ce}</text>`:q}`:q}
                    ...
                    <text x="${e.G.cx}" y="${e.G.labelY+r}" class="clickable"
                          ...
                          text-anchor="middle" font-family="${i}" font-size="${r}"
                          font-weight="800" fill="${Me}">${ze}</text>
                    ...
                    <text x="${e.G.cx}" y="${e.G.labelY+r+s+a+4}" class="clickable"
                          ...
                          text-anchor="middle" font-family="${i}" font-size="${a+1}"
                          fill="#488fc2" opacity="0.6" font-weight="600">${de}</text>
                    ...
                    <text x="${e.H.cx}" y="${e.H.labelY+1.1*r}" class="clickable"
                          ...
                          text-anchor="middle" font-family="${i}" font-size="${r}"
                          font-weight="800" fill="#5BC8D8">${Se}</text>
                    ...
                    <text x="${e.E.cx}" y="${e.E.labelY+1*r}" class="clickable"
                          ...
                          text-anchor="middle" font-family="${i}" font-size="${r}"
                          font-weight="800" fill="#8DC892">${Ce}</text>
                    ...
                    ${ve.length>0?W`
                        <foreignObject x="${t?8:10}" y="${e.statusY}" width="220" height="22">
                            <div xmlns="http://www.w3.org/1999/xhtml"
                                 style="font-family:'Segoe UI','Roboto',sans-serif;font-size:11px;color:#ef5350;opacity:0.75;white-space:nowrap">⚠ ${ve.length} ${this._t("sensor_unavailable")}</div>
                        </foreignObject>
                    `:q}
        ...
        `}_illustrationBattery(e,t,i,s,r,a,o,n){const l=i/50,c=40*l,d=64*l,p=e-c/2,h=t-d/2,_=8*l,g=16*l,u=c-8*l,m=d-12*l,f=p+4*l,y=h+8*l;return G`
            <circle cx="${e}" cy="${t}" r="${i+4}" fill="none"
        ...
        `}_illustrationHouse(e,t,i){const s=i/62,r=80*s,a=52*s,o=e-r/2,n=t-a/2+8*s,l=n-38*s,c=e+18*s,d=l+8*s,p=10*s,h=18*s,_=16*s,g=14*s,u=n+12*s,m=o+10*s,f=o+r-10*s-_,y=14*s,v=24*s,b=e-y/2,x=n+a-v;return G`
            <circle cx="${e}" cy="${t}" r="${i+4}" fill="none"
        ...
        `)}_collectDevices(){const e=this._eid("controllable_devices_count"),t=e?this._hass?.states[e]:void 0;return t?.attributes?.devices?Object.entries(t.attributes.devices).filter(([,e])=>"ev_charger"!==e.device_type&&"battery"!==e.device_type).map(([e,t])=>{const i=t.power_entity?this._hass.states[t.power_entity]:null,s=i?parseFloat(i.state)||0:t.current_power||0;return{id:e,...t,power:s,name:this._localizedDeviceName(e,t)}}).sort((e,t)=>t.power-e.power).slice(0,3):[]}_localizedDeviceName(e,t){const i={heat_pump:"device_heat_pump",hot_water:"device_hot_water"},s={heat_pump:"Heat Pump",hot_water:"Hot Water"}[e];if(s&&(t.name||"").trim()===s){const t=this._t(i[e]);if(t)return t}return t.name||e}_renderDeviceChips(){const e=this._collectDevices();return e.length?W`
            ...
            <feMerge><feMergeNode/><feMergeNode in="SourceGraphic"/></feMerge>
                       ...
                       <line x1="-1.5" y1="6" x2="1.5" y2="6"/>`:G`<path d="M-2.5,-9 L-2.5,0 L-5,0 L0,9 L0,0 L2.5,0 L-2.5,-9Z"/>`}getCardSize(){return 7}static getStubConfig(){return{entity_prefix:"sensor.sem_"}}},{type:"sem-system-diagram-card",name:"SEM System Diagram",description:"Power flow visualization with inline SVG illustrations for each energy component",documentationURL:"https://github.com/traktore-org/sem-community/blob/develop/docs/DASHBOARD_GUIDE.md#sem-system-diagram-card"});const Tt=["/local/custom_components/xxx_cristiano/dashboard/card/vendor/chart.umd.min.js","https://cdn.jsdelivr.net/npm/chart.js@4.4.7/dist/chart.umd.min.js"],Lt=["/local/custom_components/xxx_cristiano/dashboard/card/vendor/chartjs-adapter-date-fns.bundle.min.js","https://cdn.jsdelivr.net/npm/chartjs-adapter-date-fns@3.0.0/dist/chartjs-adapter-date-fns.bundle.min.js"];function Ut(e,t,i){if(!e.length)return void i(new Error("all sources failed"));const s=document.createElement("script");s.src=e[0],s.onload=()=>t(),s.onerror=()=>Ut(e.slice(1),t,i),document.head.appendChild(s)}let Ot=null;const Ht=pe||{solar:"#ff9800",gridImport:"#488fc2",gridExport:"#8353d1",batteryOut:"#4db6ac",home:"#5BC8D8",ev:"#8DC892"},Wt={costs:{title:"energy_costs",y_label:"_currency_",stacked:!1,daily:[{suffix:"daily_costs",name:"Import",color:Ht.gridImport,type:"bar",negate:!0},{suffix:"daily_export_revenue",name:"export",color:Ht.gridExport,type:"bar"},{suffix:"daily_net_cost",name:"net",color:Ht.solar,type:"line",negate:!0}],monthly:[{suffix:"monthly_costs",name:"Import",color:Ht.gridImport,type:"bar",negate:!0},{suffix:"monthly_export_revenue",name:"export",color:Ht.gridExport,type:"bar"},{suffix:"monthly_net_cost",name:"net",color:Ht.solar,type:"line",negate:!0}]},savings:{title:"energy_savings",y_label:"_currency_",stacked:!0,daily:[{suffix:"daily_savings",name:"solar_savings",color:Ht.solar,type:"area"},{suffix:"daily_battery_savings",name:"battery_savings",color:Ht.batteryOut,type:"area"}],monthly:[{suffix:"monthly_savings",name:"solar_savings",color:Ht.solar,type:"area"},{suffix:"monthly_battery_savings",name:"battery_savings",color:Ht.batteryOut,type:"area"}]},energy:{title:"energy_balance",y_label:"kWh",stacked:!1,defaultPeriod:"7d",daily:[{suffix:"daily_solar_energy",name:"solar",color:Ht.solar,type:"bar"},{suffix:"daily_home_energy",name:"home",color:Ht.home,type:"bar"},{suffix:"daily_grid_import_energy",name:"grid_import",color:Ht.gridImport,type:"bar"},{suffix:"daily_grid_export_energy",name:"grid_export",color:Ht.gridExport,type:"bar"}],monthly:[{suffix:"monthly_solar_energy",name:"solar",color:Ht.solar,type:"bar"},{suffix:"monthly_home_energy",name:"home",color:Ht.home,type:"bar"},{suffix:"monthly_grid_import_energy",name:"grid_import",color:Ht.gridImport,type:"bar"},{suffix:"monthly_grid_export_energy",name:"grid_export",color:Ht.gridExport,type:"bar"}]},power:{title:"power_flow",y_label:"W",stacked:!1,hourly:[{suffix:"solar_power",name:"solar",color:Ht.solar,type:"area"},{suffix:"home_consumption_power",name:"home",color:Ht.home,type:"area"},{suffix:"grid_power",name:"grid",color:Ht.gridImport,type:"area"}]},forecast:{title:"forecast_vs_actual",y_label:"W",stacked:!1,hourly:[{suffix:"forecast_power_now_w",name:"forecast",color:Ht.solar,type:"area"},{suffix:"solar_power",name:"actual",color:Ht.batteryOut,type:"line"}]},battery:{title:"battery",y_label:"W",y2_label:"%",stacked:!1,hourly:[{suffix:"battery_power",name:"power",color:Ht.batteryOut,type:"area"},{suffix:"battery_soc",name:"soc",color:"#ff9800",type:"line",y_axis:1}]},ev:{title:"ev_charging",y_label:"W",stacked:!0,defaultPeriod:"today",y_min:0,y_suggested_max:2e3,hourly:[{suffix:"flow_solar_to_ev_power",name:"solar",color:Ht.solar,type:"area"},{suffix:"flow_battery_to_ev_power",name:"battery",color:Ht.batteryOut,type:"area"},{suffix:"flow_grid_to_ev_power",name:"grid",color:Ht.gridImport,type:"area"}],daily:[{suffix:"daily_ev_energy",name:"ev_energy",color:Ht.ev,type:"bar"}],monthly:[{suffix:"monthly_ev_energy",name:"ev_energy",color:Ht.ev,type:"bar"}]}};we("sem-chart-card",class extends Se{constructor(){super(),this._chart=null,this._period=null,this._fetchTimer=null,this._cachedChartTheme=null,this._boundPeriodHandler=e=>this._onPeriodChange(e.detail),this._prefix="sensor.sem_",this._preset=null,this._emptyMsg=""}setConfig(e){if(!e.preset&&!e.series)throw new Error("sem-chart-card requires either preset or series config");this._config=e,this._prefix=e.entity_prefix||"sensor.sem_",this._preset=e.preset?Wt[e.preset]:null,this.requestUpdate()}set hass(e){this._hass=e;const t=e?.language;if(t!==this._lang)return this._lang=t,void this.requestUpdate();this._period||this._setDefaultPeriod()}get hass(){return this._hass}connectedCallback(){super.connectedCallback(),document.addEventListener("sem-period-change",this._boundPeriodHandler),this._rollInterval=setInterval(()=>this._rollRelativePeriod(),3e5),this._boundVisibility=()=>{document.hidden||this._rollRelativePeriod()},document.addEventListener("visibilitychange",this._boundVisibility)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("sem-period-change",this._boundPeriodHandler),this._boundVisibility&&document.removeEventListener("visibilitychange",this._boundVisibility),clearInterval(this._rollInterval),this._chart&&(this._chart.destroy(),this._chart=null),clearTimeout(this._fetchTimer)}_rollRelativePeriod(){if(!this._period||!this._hass)return;const e=this._config?.default_period||this._preset?.defaultPeriod,t="24h"===e?"24h":"7d"===e?"7d":"today"===e?"today":"week";this._period.key===t&&this._setDefaultPeriod()}firstUpdated(){this._period||this._setDefaultPeriod()}static get styles(){return[ke,a`
            :host { display: block; }
            .sem-chart-wrap {
                padding: 16px;
                min-height: 280px;
            ...
            <ha-card>
                <div class="card-content">
                    ...
                    <div id="device-list" class="device-list">
                        ${0===this.devices.length?W`<div class="empty">${this._t("no_devices_yet")}</div>`:Qt(this.devices,e=>e.id,(e,t)=>this._renderDevice(e,t+1))}
                    </div>
        ...
        <div class="device${r?" is-child":""}" data-id="${e.id}" style="${o}">
            ...
            <div class="range-wrap">
                ...
                <div class="range-track">
                    ...
                    ${d?W`
                        <span class="range-split" style="left:${o}%"
                              title="${this._t("separate_handles")}"
            ...
            <div class="range-wrap">
                <div class="range-labels">
                    ...
                    <span><b style="color:#488fc2">${s}</b></span>
                </div>
                <div class="range-track">
                    <div class="range-fill" style="left:0;width:${i}%;background:#488fc2"></div>
                    <div class="range-handle range-handle-peak" style="left:${i}%"
                         @pointerdown=${e=>this._peakSliderStart(e)}></div>
                </div>
            </div>`}_peakSliderStart(e){e.stopPropagation(),e.preventDefault();const t=e.currentTarget.parentElement.getBoundingClientRect(),i=e=>{let i=(e-t.left)/(t.width||1);return i=Math.max(0,Math.min(1,i)),.5*Math.round((1+79*i)/.5)},s=e=>{this._peakDrag=i(e),this.requestUpdate()};s(e.clientX);const r=e=>s(e.clientX),a=e=>{window.removeEventListener("pointermove",r),window.removeEventListener("pointerup",a),window.removeEventListener("pointercancel",a);const t=i(e.clientX);this._peakDrag=null;const s=t>=79.999999;this.targetPeakLimit=t,this.peakLimitUnlimited=s,this._sendTargetPeakUpdate(t,s),this.requestUpdate()};window.addEventListener("pointermove",r),window.addEventListener("pointerup",a),window.addEventListener("pointercancel",a)}_onStopEntity(e,t){t.stopPropagation();const i=t.detail&&t.detail.value||"";e.goals=e.goals||{},e.goals.stop_entity=i,this._sendDeviceUpdate(e.id,"stop_entity",i)}_overnightSource(e){const t=e.goals||{};return t.battery_eligible_overnight?"battery":"cheap_hours"===t.top_up_policy?"grid":"off"}_renderOvernightPicker(e){const t=this._overnightSource(e),i=(i,s)=>W`
            <button class="ov-opt ${t===i?"on":""}"
                    data-action="set-overnight" data-overnight="${i}"
                    data-device="${e.id}">${s}</button>`;return W`
            <div class="ge-row">
                <span class="ge-label">${this._t("finish_overnight_from")}</span>
                <span class="ge-ctl ov-picker">
                    ${i("off",this._t("overnight_off"))}
                    ${i("battery",this._t("overnight_battery"))}
            ...
            <div class="ge-title" style="margin-top:10px">
                ...
                <a class="ge-docs" href="${ai}" target="_blank"
                   rel="noopener" title="${this._t("config_docs")}"
                   @click=${e=>e.stopPropagation()}>
            ...
            ${r.map((i,r)=>{const a=i.id||s[r];return a?W`
                <div class="charger-block">
                    ...
                    ${"soc"===i.ev_target_type?W`
                        <div class="stepper-pair">
                            ${this._renderStepper(`number.sem_charger_${a}_target_soc`,"config_ev_target_soc",e,"config_help_ev_target_soc")}
                            ${this._renderStepper(`number.sem_charger_${a}_target_soc_max`,"config_ev_target_soc_max",e,"config_help_ev_target_soc_max")}
                        </div>`:W`
                        <div class="stepper-pair">
                            ${this._renderStepper(`number.sem_charger_${a}_daily_ev_target`,"config_ev_daily_target",e,"config_help_ev_daily_target")}
                            ${this._renderStepper(`number.sem_charger_${a}_daily_ev_target_max`,"config_ev_daily_target_max",e,"config_help_ev_daily_target_max")}
                        </div>`}
                    ${""}
                    <div class="stepper-pair">
                        ${this._renderStepper(`number.sem_charger_${a}_ev_battery_capacity_kwh`,"capacity_kwh",e,"tile_help_capacity")}
                        ${this._renderStepper(`number.sem_charger_${a}_ev_kwh_per_100km`,"config_ev_kwh_per_100km",e,"config_help_ev_kwh_per_100km")}
                    </div>
                    <div class="stepper-pair">
        ...
        `}_renderSensorSources(e){const t=this._options||{};return W`
            ...
            ${this._renderPicker("grid_power_sensor","config_grid_power_sensor","sensor","power",t,"config_help_grid_power_sensor")}
            ${this._sourceUnavailableWarning("grid_power_sensor",t,e)}
        ...
        `}_renderPicker(e,t,i,s,r,a){if(!this._showsControl(e))return q;const o=this._saveStatus[e],n=gi.has(e),l=n&&Object.prototype.hasOwnProperty.call(this._pending,e),c=l?this._pending[e]:r[e]||"",d=t=>{n?(this._pending={...this._pending,[e]:t||""},this.requestUpdate()):this._saveOption(e,t,e)};return W`
            <div class="picker-cell">
                <div class="picker-row">
        ...
        `}_renderOptionToggle(e,t,i,s,r){if(!this._showsControl(e))return q;const a=gi.has(e),o="opt:"+e;a||this._reg(o);const n=a&&Object.prototype.hasOwnProperty.call(this._pending,e),l=null!=i[e]?!!i[e]:!!r,c=n||!a&&this._isDirty(o),d=n?!!this._pending[e]:!a&&this._isDirty(o)?!!this._staged[o].value:l;return W`
        ...
        `}_renderAdvanced(e){const t=this._options||{};return W`
            ...
            ${this._renderPicker("vpp_event_active_entity","config_vpp_event_entity",["binary_sensor","sensor"],null,t,"config_help_vpp_event_active_entity")}
            ${this._renderPicker("vpp_direction_entity","config_vpp_direction_entity",["sensor","select","input_select"],null,t,"config_help_vpp_direction_entity")}
            ${this._renderPicker("vpp_event_end_entity","config_vpp_event_end_entity","sensor","timestamp",t,"config_help_vpp_event_end_entity")}
            ${this._renderPicker("vpp_pre_event_entity","config_vpp_pre_event_entity",["binary_sensor","sensor"],null,t,"config_help_vpp_pre_event_entity")}
            ...
            ${this._renderRetention(e)}
            ${this._renderGridSignFix(e)}
        `}_renderRetention(e){const t=this._options||{};return W`
            <div style="margin-top:6px;border-top:1px solid ${e.surfaceBorder};padding-top:4px"></div>
            ${this._renderOptionSlider("status_retention_days","config_retention_label",{min:0,max:14,step:1,unit:" "+this._t("config_retention_unit_days"),default:0},t,"config_help_retention")}
        ...
        `}async _purgeStatusHistory(){this._retentionBusy=!0,this.requestUpdate();try{await this._hass.callService("xxx_cristiano","purge_status_history",{}),this._retentionMsg="OK"}catch(e){this._retentionMsg=String(e&&e.message?e.message:e).slice(0,60)}this._retentionBusy=!1,this.requestUpdate()}_renderGridSignFix(e){const t=this._val("diag_grid_sign")||"—",i=this._val("diag_battery_sign")||"—";return W`
        ...
        `}render(){if(!this._config)return q;const e=this._theme(),t=!1!==e.isDark,i=e.accent||"#42a5f5",s={overview:e=>this._renderOverview(e),sensor_sources:e=>this._renderSensorSources(e),detected_hardware:e=>this._renderDetectedHardware(e),ev_chargers:e=>this._renderEvChargers(e),battery_zones:e=>this._renderBatteryZones(e),tariff:e=>this._renderTariff(e),heat_pump:e=>this._renderHeatPump(e),hot_water:e=>this._renderHotWater(e),battery_scheduler:e=>this._renderBatteryScheduler(e),load_management:e=>this._renderLoadManagement(e),forecast:e=>this._renderForecast(e),pv_strings:e=>this._renderPvStrings(e),notifications:e=>this._renderNotifications(e),advanced:e=>this._renderAdvanced(e)};return W`
            <style>
                ...
                .advanced-toggle-row:hover { color: var(--primary-text-color, ${e.text}); }
                .section-content {
            ...
            <ha-card>
                <div class="wrap">
                    ...
                    ${hi.filter(e=>"pv_strings"!==e.id||this._pvStrings().length>=2).filter(e=>this._advanced||ci.has(e.id)||this._sectionConfigured(e.id)).map(t=>this._renderSection(t,s[t.id],e))}
                </div>
            </ha-card>
        `}getCardSize(){return 12}static getStubConfig(){return{entity_prefix:"sensor.sem_"}}},{type:"sem-config-card",name:"SEM Configuration Card",description:"In-dashboard SEM configuration surface (replaces the Settings → SEM → Configure flow for most users)",documentationURL:"https://github.com/traktore-org/sem-community/blob/develop/docs/DASHBOARD_GUIDE.md#sem-config-card",preview:!1});const ui="sem-config-tab-introduced-v1";we("sem-onboarding-banner",class extends Se{static get watchedEntities(){return[]}static get properties(){return{...super.properties,_dismissed:{state:!0}}}constructor(){super(),this._dismissed=this._isDismissed()}setConfig(e){super.setConfig(e),this._configPath=e.config_tab_path||"/config"}_isDismissed(){try{return"1"===localStorage.getItem(ui)}catch(e){return!1}}_dismiss(){try{localStorage.setItem(ui,"1")}catch(e){}this._dismissed=!0}_openConfig(){const e=window.location.pathname.split("/").filter(Boolean);if(e.length>=2){const t="/"+e.slice(0,-1).join("/");window.history.pushState(null,"",`${t}/config`)}else window.history.pushState(null,"",this._configPath);window.dispatchEvent(new Event("location-changed",{composed:!0})),this._dismiss()}render(){if(this._dismissed)return q;if(!this._config)return q;const e=this._theme(),t="#8DC892";return W`
            <style>
                :host { display: block; }
                .banner {
                    display: flex; align-items: center; gap: 12px;
        ...
        `}getCardSize(){return 1}static getStubConfig(){return{}}},{type:"sem-onboarding-banner",name:"SEM Onboarding Banner",description:"One-time welcome banner pointing existing users to the new Configuration tab",documentationURL:"https://github.com/traktore-org/sem-community/blob/develop/docs/DASHBOARD_GUIDE.md#sem-onboarding-banner",preview:!1});class mi extends Se{static get properties(){return{...super.properties,section:{type:String},label:{type:String},_open:{state:!0},_busy:{state:!0},_payload:{state:!0},_error:{state:!0},_copied:{state:!0}}}constructor(){super(),this.section="all",this.label="",this._open=!1,this._busy=!1,this._payload=null,this._error=null,this._copied=!1,this._copiedTimer=null}disconnectedCallback(){super.disconnectedCallback(),this._copiedTimer&&(clearTimeout(this._copiedTimer),this._copiedTimer=null)}static get watchedEntities(){return[]}async _click(){if(this._hass){this._open=!0,this._busy=!0,this._error=null,this._payload=null;try{const e=await this._hass.callService("xxx_cristiano","diagnose",{section:this.section||"all"},void 0,void 0,!0);this._payload=e?.response||e}catch(e){this._error=e?.message||String(e),console.error("[sem-diagnose-button] failed",e)}finally{this._busy=!1}}}_close(){this._open=!1,this._copied=!1,this._payload=null,this._error=null}async _copy(){if(!this._payload)return;const e=JSON.stringify(this._payload,null,2),t=()=>{this._copied=!0,this._error=null,this._copiedTimer&&clearTimeout(this._copiedTimer),this._copiedTimer=setTimeout(()=>{this._copiedTimer=null,this._copied=!1},1500)};if(navigator?.clipboard?.writeText&&!1!==window.isSecureContext)try{return await navigator.clipboard.writeText(e),void t()}catch(e){console.warn("[sem-diagnose-button] modern clipboard refused, falling back to execCommand",e)}try{const i=document.createElement("textarea");i.value=e,i.setAttribute("readonly",""),i.style.position="fixed",i.style.top="0",i.style.left="0",i.style.width="1px",i.style.height="1px",i.style.opacity="0",document.body.appendChild(i),i.focus(),i.select();const s=document.execCommand("copy");if(document.body.removeChild(i),s)return void t();console.error('[sem-diagnose-button] execCommand("copy") returned false')}catch(e){console.error("[sem-diagnose-button] legacy clipboard fallback threw",e)}this._error=this._t("config_diagnose_clipboard_failed")}render(){const e=this._theme(),t=e.accent||"#5BC8D8",i=this.label||this._t("config_diagnose");return W`
            ...
            `:q}
        `}}customElements.get("sem-diagnose-button")||customElements.define("sem-diagnose-button",mi),console.info("%c SEM Cards %c Lit Bundle ","color: #4db6ac; font-weight: bold; background: #1e232d; padding: 2px 6px; border-radius: 4px 0 0 4px;","color: #ff9800; background: #1e232d; padding: 2px 6px; border-radius: 0 4px 4px 0;");
